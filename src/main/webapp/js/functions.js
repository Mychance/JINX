...
$(function() {
    ...
    $("#content").css("margin-top", Math.max(($window.height() - $("#content").height() - $("#code").height()) / 2, 10));
    $("#content").css("margin-left", Math.max(($window.width() - $("#content").width()) / 2, 10));
    $("#code").css("margin-left", Math.max(($window.width() - $("#code").width()) / 2 - Math.max(($window.width() - $("#content").width()) / 2, 10), 10))
...
function adjustWordsPosition() {
    ...
    $("#words").css("top", $("#garden").position().top + 135);
